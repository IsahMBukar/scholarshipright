            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <Field label="Field of study">
                  <FieldOfStudyPicker
              value={editForm.field_of_study ? [editForm.field_of_study] : []}
              onChange={(next) => setEditForm({ ...editForm, field_of_study: next[0] ?? '' })}
          ...
          <div className="space-y-4">
            ...
            <Field label="Target Fields">
              <FieldOfStudyPicker
                ...
                onChange={(next) => setEditForm({ ...editForm, target_fields: next })}
              />
            </Field>
          </div>
      ...
      {editing === 'research_interests' && (
        <Modal title="Edit Research Interests" onClose={() => setEditing(null)}>
          <FieldOfStudyPicker
            ...
            onChange={(next) => setEditForm({ ...editForm, research_interests: next })}
          />
